...
{
extract($_POST);
$addque=mysqli_real_escape_string($con,$addque);
$ans1=mysqli_real_escape_string($con,$ans1);
$ans2=mysqli_real_escape_string($con,$ans2);
$ans3=mysqli_real_escape_string($con,$ans3);
$ans4=mysqli_real_escape_string($con,$ans4);
...
$stmt="select * from mst_question where test_id='$testid'";
$data=$conn->query($stmt);
$num=mysqli_num_rows($data);
echo "<p align=center>  No. of Questions= $num </p>";
unset($_POST);
}
?>
