...
?>
 <table width="100%" border="0">
   ...
   <tr>
     <td><form name="form1" method="post" action="signupuser.php" onSubmit="return check();">
       <center>
		<!--<img class="img-circle" src="2.jpg"  width="240px" height="190px" border="1" />-->
         ...
         <tr>
           <td valign="top" class="style7">Phone 1</td>
           <td><input class="form-control" name="phone" type="text" id="phone"></td>
         </tr>
          <tr>
           <td valign="top" class="style7">Phone 2</td>
           <td><input class="form-control" name="phone2" type="text" id="phone"></td>
         </tr>
          <tr>
          ...
          <tr>
           <td valign="top" class="style7">Qualification</td>
           <td><select name="q">
    ...
    <tr><td>&nbsp;</td>
           <td><a href="admin/login.php"><button>Back </button> </a>
           </td></tr>
 </table>
 <p>&nbsp; </p>
</body>
